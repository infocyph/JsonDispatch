...
[12. Implementation Patterns](#12-implementation-patterns)    
    [12.1 PHP (PSR Middleware Example)](#121-php-psr-middleware-example)    
    [12.2 Node.js (Express Middleware Example)](#122-nodejs-express-middleware-example)    
    [12.3 Shell (CLI Healthcheck Example)](#123-shell-cli-healthcheck-example)
